...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Meilleur personnage Sugo-Rare</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Meilleur personnage Sugo-Rare</u></center></h1>
      <center><img src="https://i.imgur.com/cdwYpL0.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=legende2">English Version</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - Cette catégorie permettra de décerner <b>l'Award du meilleur personnage Sugo-Rare</b> parmi les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Nombre de votes :</u> 2 372</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Combat commun entre amis</h4>
  ...
  <br><br><br>
    <center><h2><u>Nominés</u></h2></center>
    <center><div class="col-sm-12">
  <div class="row justify-content-center">
  <div class="col-sm-4">
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Pirates solidaires</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Deux Empereurs menaçants</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Alliance pour ouvrir le pays des Wa</h4>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=legende&action=submit">
      <label for="select_1">Sélectionnez votre choix :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Équipage de Shanks le Roux - Pirates solidaires</option>
        <option value="2">Trafalgar Law - Alliance pour ouvrir le pays des Wa</option>
        <option value="3">Luffy et Sanji - Combat commun entre amis</option>
        <option value="4">Kaido VS Big Mom - Deux Empereurs menaçants</option>
      </select>
    <br>
