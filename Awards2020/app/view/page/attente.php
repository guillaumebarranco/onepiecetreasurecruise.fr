...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Plus grande attente pour 2021</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Plus grande attente pour 2021</u></center></h1>
      <center><img src="https://i.imgur.com/U74fYub.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=attente2">English Version</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - Cette catégorie permettra de décerner <b>l'Award de la plus grande attente pour 2021</b> parmi les personnages ou nouveautés potentielles.<br><br>
      ...
      <br/><br>
    <center><h2><u>Nombre de votes :</u> 2 451</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h2 class="card-title">Nouveau personnage "Oden Kozuki"</h2>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h2 class="card-title">Augmentation du taux de succès des stèles</h2>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h2 class="card-title">Nouveau personnage "Gol D. Roger"</h2>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h2 class="card-title">Stockage des barbes à papa</h2>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=attente&action=submit">
      <label for="select_1">Sélectionnez votre choix :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Nouveau personnage "Gol D. Roger"</option>
        <option value="2">Nouveau personnage "Oden Kozuki"</option>
        <option value="3">Augmentation du taux de succès des stèles</option>
        <option value="4">Stockage des barbes à papa</option>
      </select>
    <br>
