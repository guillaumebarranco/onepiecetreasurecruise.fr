...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Best Female Artwork</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Best Female Artwork</u></center></h1>
      <center><img src="https://i.imgur.com/vwZyUFO.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=artworkf">Version française</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - The votes for this category will help select the <b>Best Female Artwork</b> amongst characters released between 1st December 2019 and 30th November 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Number of votes :</u> 2 428</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Vacation on the Evening Beach</h4>
      <h2 class="card-title">Boa Hancock</h2>
      <p class="card-text"><b>1 089 votes (44,85 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/3038" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
  ...
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/y1Z6S3F.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Break Time for Lovely Ladies</h4>
      <h2 class="card-title">Nami & Robin</h2>
      <p class="card-text"><b>597 votes (24,59 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2835" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/fGqALyc.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Love and Separation</h4>
      <h2 class="card-title">Charlotte Pudding</h2>
      <p class="card-text"><b>472 votes (19,44 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2837" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/02AsFlY.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Happy White Christmas</h4>
      <h2 class="card-title">Vivi & Rebecca</h2>
      <p class="card-text"><b>270 votes (11,12 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/3164" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=artworkf2&action=submit">
      <label for="select_1">Select your choice :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Nami & Robin - Break Time for Lovely Ladies</option>
        <option value="2">Charlotte Pudding - Love and Separation</option>
        <option value="3">Boa Hancock - Vacation on the Evening Beach</option>
        <option value="4">Vivi & Rebecca - Happy White Christmas</option>
      </select>
    <br>
