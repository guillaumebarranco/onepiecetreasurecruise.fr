...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Best new feature</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Best new feature</u></center></h1>
      <center><img src="https://i.imgur.com/qpCsb0X.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=nouveaute">Version française</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - The votes for this category will help select the <b>Best new feature</b> amongst all new features released between 1st December 2019 and 30th November 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Number of votes :</u> 2 642</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h2 class="card-title">Super Type</h2>
      <p class="card-text"><b>871 votes (32,97 %)</b></p>
    </div>
  </div>
  </div>
  </div>
  ...
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/FikS0Yx.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h2 class="card-title">Pirate Rumble</h2>
      <p class="card-text"><b>826 votes (31,26 %)</b></p>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/qRKqg9N.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h2 class="card-title">Medal Exchange</h2>
      <p class="card-text"><b>657 votes (24,87 %)</b></p>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/xg5JlOb.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h2 class="card-title">Gather Island</h2>
      <p class="card-text"><b>288 votes (10,9 %)</b></p>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=nouveaute2&action=submit">
      <label for="select_1">Select your choice :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Pirate Rumble</option>
        <option value="2">Gather Island</option>
        <option value="3">Super Type</option>
        <option value="4">Medal Exchange</option>
      </select>
    <br>
