...
position: absolute;
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <body>
      ...
      <h3><center><u>Crédits à Toadskii pour le logo</u></center></h3>
      <center><a class="btn btn-primary" href="index.php?page=index2">English Version</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - Un seul envoi par personne par catégorie, tous les votes provenant d'une même personne sur une même catégorie seront annulés s'il y en a 2 ou plus.<br><br>
                               - Vous pouvez participer aux catégories que vous souhaitez.<br><br>
      ...
      <br><br>
    <h2><center><u>Partenaires</u></center></h2>
    <br><br>
    <div class="col-sm-12">
      <div class="row justify-content-center">
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><h2 class="card-title">Vidéo de Toadskii (vote)</h2></center>
        ...
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><h2 class="card-title">Live de Towercorner (vote)</h2></center>
      ...
      <div class="row justify-content-center">
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><h2 class="card-title">Vidéo de Toadskii (résultats)</h2></center>
        ...
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><h2 class="card-title">Live de Towercorner (résultats)</h2></center>
    ...
    <br><br>
    <center><h2><u>Nombre de votes :</u> 35 064</h2></center>
    <br><br>
    <h2><center><u>Catégories</u></center></h2>
    <br><br>
    <div class="col-sm-12">
      <div class="row">
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              ...
              <center><h2 class="card-title">Meilleure nouveauté</h2></center>
              <p class="card-text">Cette catégorie permettra de décerner <b>l'Award de la meilleure nouveauté (version GLB ou version JPN)</b> parmi toutes les nouveautés sorties entre le 1er décembre 2019 et le 30 novembre 2020</p>
              <center><a href="index.php?page=nouveaute" class="btn btn-primary">Accès aux résultats</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              ...
              <center><h2 class="card-title">Meilleur moment</h2></center>
              <p class="card-text">Cette catégorie permettra de décerner <b>l'Award du meilleur moment (uniquement ceux de la version GLB)</b> parmi tout ce qui s'est passé sur le jeu entre le 1er décembre 2019 et le 30 novembre 2020</p>
              <center><a href="index.php?page=moment" class="btn btn-primary">Accès aux résultats</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              ...
              <center><h2 class="card-title">Meilleur Sugo-Fest</h2></center>
              <p class="card-text">Cette catégorie permettra de décerner <b>l'Award du meilleur Sugo-Fest (uniquement ceux de la version GLB)</b> parmi tous les Sugo-Fest ayant eu lieu entre le 1er décembre 2019 et le 30 novembre 2020</p>
              <center><a href="index.php?page=sugo" class="btn btn-primary">Accès aux résultats</a></center>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              ...
              <center><h2 class="card-title">Plus grande attente pour 2021</h2></center>
              <p class="card-text">Cette catégorie permettra de décerner <b>l'Award de la plus grande attente pour 2021</b> parmi les personnages ou nouveautés potentielles</p>
              <center><a href="index.php?page=attente" class="btn btn-primary">Accès aux résultats</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              ...
              <center><h2 class="card-title">Meilleur Artwork masculin</h2></center>
              <p class="card-text">Cette catégorie permettra de décerner <b>l'Award du meilleur Artwork masculin</b> parmi tous les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020</p>
              <center><a href="index.php?page=artwork" class="btn btn-primary">Accès aux résultats</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              ...
              <center><h2 class="card-title">Meilleur Artwork féminin</h2></center>
              <p class="card-text">Cette catégorie permettra de décerner <b>l'Award du meilleur Artwork féminin</b> parmi tous les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020</p>
              <center><a href="index.php?page=artworkf" class="btn btn-primary">Accès aux résultats</a></center>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              ...
              <center><h2 class="card-title">Meilleur personnage des combats cruciaux / attaques ennemies</h2></center>
              <p class="card-text">Cette catégorie permettra de décerner <b>l'Award du meilleur personnage des combats cruciaux / attaques ennemies</b> parmi les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020</p>
              <center><a href="index.php?page=raid" class="btn btn-primary">Accès aux résultats</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              ...
              <center><h2 class="card-title">Meilleur personnage des Colisées / Arènes</h2></center>
              <p class="card-text">Cette catégorie permettra de décerner <b>l'Award du meilleur personnage des Colisées / Arènes</b> parmi les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020</p>
              <center><a href="index.php?page=colisee" class="btn btn-primary">Accès aux résultats</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
        ...
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              ...
              <center><h2 class="card-title">Meilleur personnage de la Carte aux trésors</h2></center>
              <p class="card-text">Cette catégorie permettra de décerner <b>l'Award du meilleur personnage de la Carte aux trésors</b> parmi les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020</p>
              <center><a href="index.php?page=tm" class="btn btn-primary">Accès aux résultats</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              ...
              <center><h2 class="card-title">Meilleur personnage du combat de l'amitié</h2></center>
              <p class="card-text">Cette catégorie permettra de décerner <b>l'Award du meilleur personnage du combat de l'amitié</b> parmi les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020</p>
              <center><a href="index.php?page=kizuna" class="btn btn-primary">Accès aux résultats</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              ...
              <center><h2 class="card-title">Personnage le plus utile sur la fête des pirates</h2></center>
              <p class="card-text">Cette catégorie permettra de décerner <b>l'Award du personnage le plus utile sur la fête des pirates</b> parmi tous les personnages ayant des effets sur la fête des pirates</p>
              <center><a href="index.php?page=pf" class="btn btn-primary">Accès aux résultats</a></center>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              ...
              <center><h2 class="card-title">Meilleur personnage du recrutement rare</h2></center>
              <p class="card-text">Cette catégorie permettra de décerner <b>l'Award du meilleur personnage du recrutement rare (spéciaux non compris)</b> parmi les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020</p>
              <center><a href="index.php?page=rr" class="btn btn-primary">Accès aux résultats</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><img class="card-img-top" src="https://i.imgur.com/aqrrntd.png" alt="Card image cap"></center>
              <center><h2 class="card-title">Meilleure super évolution</h2></center>
              <p class="card-text">Cette catégorie permettra de décerner <b>l'Award de la meilleure super évolution</b> parmi les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020</p>
              <center><a href="index.php?page=supevo" class="btn btn-primary">Accès aux résultats</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              ...
              <center><h2 class="card-title">Meilleur personnage Sugo-Rare</h2></center>
              <p class="card-text">Cette catégorie permettra de décerner <b>l'Award du meilleur personnage Sugo-Rare</b> parmi les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020</p>
              <center><a href="index.php?page=legende" class="btn btn-primary">Accès aux résultats</a></center>
            </div>
          </div>
        </div>
      </div>
