...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Best Super Evolution</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Best Super Evolution</u></center></h1>
      <center><img src="https://i.imgur.com/1VGlixW.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=supevo">Version française</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - The votes for this category will help select the <b>Best Super Evolution</b> amongst characters released between 1st December 2019 and 30th November 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Number of votes :</u> 2 272</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">End of the Long Journey</h4>
      <h2 class="card-title">Whitebeard</h2>
      <p class="card-text"><b>991 votes (43,62 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2909" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
  ...
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/pxqOGih.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Old Soldier Watching Over the Next Generation</h4>
      <h2 class="card-title">"Dark King" Silvers Rayleigh</h2>
      <p class="card-text"><b>748 votes (32,92 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/3018" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/jiOVKFj.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Grandfather of the Future King of the Pirates</h4>
      <h2 class="card-title">Garp the Fist</h2>
      <p class="card-text"><b>408 votes (17,96 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2991" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/9AqPAYn.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Blue-Flamed Mythical Beast</h4>
      <h2 class="card-title">Marco the Phoenix</h2>
      <p class="card-text"><b>125 votes (5,5 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2868" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=supevo2&action=submit">
      <label for="select_1">Select your choice :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Marco the Phoenix - Blue-Flamed Mythical Beast</option>
        <option value="2">Whitebeard - End of the Long Journey</option>
        <option value="3">Garp the Fist - Grandfather of the Future King of the Pirates</option>
        <option value="4">"Dark King" Silvers Rayleigh - Old Soldier Watching Over the Next Generation</option>
      </select>
    <br>
