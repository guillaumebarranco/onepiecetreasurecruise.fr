...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Best Coliseum / Arena character</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Best Coliseum / Arena character</u></center></h1>
      <center><img src="https://i.imgur.com/dE32XyI.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=colisee">Version française</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - The votes for this category will help select the <b>Best Coliseum / Arena character</b> amongst characters released between 1st December 2019 and 30th November 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Number of votes :</u> 2 190</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Reunion Duel</h4>
      <h2 class="card-title">Dogstorm</h2>
      <p class="card-text"><b>687 votes (31,37 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2908" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
  ...
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/PhH4BCV.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title"> </h4>
      <h2 class="card-title">King</h2>
      <p class="card-text"><b>611 votes (27,9 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2990" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/foWF1zE.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Oiran with the Kitsune Mask</h4>
      <h2 class="card-title">Komurasaki</h2>
      <p class="card-text"><b>480 votes (21,92 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2869" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/2pyDxrV.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Soba Cart Cook</h4>
      <h2 class="card-title">Sangoro</h2>
      <p class="card-text"><b>412 votes (18,81 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2845" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=colisee2&action=submit">
      <label for="select_1">Select your choice :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Sangoro - Soba Cart Cook</option>
        <option value="2">Komurasaki - Oiran with the Kitsune Mask</option>
        <option value="3">Dogstorm - Reunion Duel</option>
