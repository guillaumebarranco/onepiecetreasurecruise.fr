...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Meilleur personnage de la Carte aux trésors</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Meilleur personnage de la Carte aux trésors</u></center></h1>
      <center><img src="https://i.imgur.com/3CeclDY.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=tm2">English Version</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - Cette catégorie permettra de décerner <b>l'Award du meilleur personnage de la Carte aux trésors</b> parmi les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Nombre de votes :</u> 2 231</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Fine lame coupeuse de paille</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Princesses du royaume de Dressrosa</h4>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=tm&action=submit">
      <label for="select_1">Sélectionnez votre choix :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">O-Robi - Geisha</option>
        <option value="2">Rebecca et Viola - Princesses du royaume de Dressrosa</option>
        <option value="3">Monkey D. Luffy - Celebrate the Astonishing Cruise</option>
        <option value="4">Zorojuro - Fine lame coupeuse de paille</option>
      </select>
    <br>
