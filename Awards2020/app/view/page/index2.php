...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu dropdown-secondary" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item active" href="../../Awards2020/">Awards 2020</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
    ...
    <body>
    	<h1><center><u>Awards 2020</u></center></h1>
      <center><img src="https://i.imgur.com/vSuCc4f.png" width="35%"></img></center>
      <h3><center><u>All credits to Toadskii for logo</u></center></h3>
      <center><a class="btn btn-primary" href="index.php?page=index">Version française</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - Voting Period : 7th December 2020 (13:00 UTC +1) - 15th December 2020 (20:59 UTC +1)<br><br>
                               - Only one submission per person per category, all votes from the same person on the same category will be canceled if there are 2 or more.<br><br>
                               - You can participate in the categories you want.<br><br>
                               - Votes are anonymous but you can tell who you have chosen on the networks.<br><br>
                               - If you have any questions, ask them at Anlord on Discord.<br>
                            </td>
                        </tr>
                    </tbody>
                </table> -->
      <br><br>
    <h2><center><u>Partners</u></center></h2>
    <br><br>
    <div class="col-sm-12">
      <div class="row justify-content-center">
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><h2 class="card-title">Video of Toadskii (vote)</h2></center>
              <center><iframe width="336" height="189" src="https://www.youtube.com/embed/DAC6BrKDYAE?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><h2 class="card-title">Live of Towercorner (vote)</h2></center>
              <center><iframe src="https://player.twitch.tv/?video=829265530&parent=onepiecetreasurecruise.fr" frameborder="0" allowfullscreen="true" scrolling="no" height="189" width="336"></iframe></center>
            </div>
          </div>
        </div>
      </div>
      <div class="row justify-content-center">
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><h2 class="card-title">Video of Toadskii (results)</h2></center>
              <center><iframe width="336" height="189" src="https://www.youtube.com/embed/QnTq64g1-Rk?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><h2 class="card-title">Live of Towercorner (results)</h2></center>
              <center><iframe src="https://player.twitch.tv/?video=839744377&parent=onepiecetreasurecruise.fr" frameborder="0" allowfullscreen="true" scrolling="no" height="189" width="336"></iframe></center>
            </div>
          </div>
        </div>
      </div>
    ...
    <br><br>
    <center><h2><u>Number of votes :</u> 35 064</h2></center>
    <br><br>
    <h2><center><u>Categories</u></center></h2>
    <br><br>
    <div class="col-sm-12">
      <div class="row">
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><img class="card-img-top" src="https://i.imgur.com/HLD0gyu.png" alt="Card image cap"></center>
              <center><h2 class="card-title">Best new feature</h2></center>
              <p class="card-text">The votes for this category will help select the <b>Best new feature</b> amongst all new features released between 1st December 2019 and 30th November 2020</p>
              <center><a href="index.php?page=nouveaute2" class="btn btn-primary">Access to results</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><img class="card-img-top" src="https://i.imgur.com/emjrFOQ.png" alt="Card image cap"></center>
              <center><h2 class="card-title">Best moment</h2></center>
              <p class="card-text">The votes for this category will help select the <b>Best moment (GLB only)</b> amongst everything that happened on the game between 1st December 2019 and 30th November 2020</p>
              <center><a href="index.php?page=moment2" class="btn btn-primary">Access to results</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><img class="card-img-top" src="https://i.imgur.com/vGZvMZT.png" alt="Card image cap"></center>
              <center><h2 class="card-title">Best Sugo-Fest</h2></center>
              <p class="card-text">The votes for this category will help select the <b>Best Sugo-Fest (GLB only)</b> amongst all Sugo-Fest that took place between 1st December 2019 and 30th November 2020</p>
              <center><a href="index.php?page=sugo2" class="btn btn-primary">Access to results</a></center>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><img class="card-img-top" src="https://i.imgur.com/phHSQia.png" alt="Card image cap"></center>
              <center><h2 class="card-title">Biggest hopes for 2021</h2></center>
              <p class="card-text">The votes for this category will help select the <b>Biggest hope for 2021</b> amongst the characters or potential new features</p>
              <center><a href="index.php?page=attente2" class="btn btn-primary">Access to results</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><img class="card-img-top" src="https://i.imgur.com/aqrrntd.png" alt="Card image cap"></center>
              <center><h2 class="card-title">Best Male Artwork</h2></center>
              <p class="card-text">The votes for this category will help select the <b>Best Male Artwork</b> amongst characters released between 1st December 2019 and 30th November 2020</p>
              <center><a href="index.php?page=artwork2" class="btn btn-primary">Access to results</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><img class="card-img-top" src="https://i.imgur.com/GCihr43.png" alt="Card image cap"></center>
              <center><h2 class="card-title">Best Female Artwork</h2></center>
              <p class="card-text">The votes for this category will help select the <b>Best Female Artwork</b> amongst characters released between 1st December 2019 and 30th November 2020</p>
              <center><a href="index.php?page=artworkf2" class="btn btn-primary">Access to results</a></center>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><img class="card-img-top" src="https://i.imgur.com/jqe6Div.png" alt="Card image cap"></center>
              <center><h2 class="card-title">Best Raid / Ambush character</h2></center>
              <p class="card-text">The votes for this category will help select the <b>Best Raid / Ambush character</b> amongst characters released between 1st December 2019 and 30th November 2020</p>
              <center><a href="index.php?page=raid2" class="btn btn-primary">Access to results</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><img class="card-img-top" src="https://i.imgur.com/zejzZJl.png" alt="Card image cap"></center>
              <center><h2 class="card-title">Best Coliseum / Arena character</h2></center>
              <p class="card-text">The votes for this category will help select the <b>Best Coliseum / Arena character</b> amongst characters released between 1st December 2019 and 30th November 2020</p>
              <center><a href="index.php?page=colisee2" class="btn btn-primary">Access to results</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              ...
              <center><h2 class="card-title">Best Special Events character</h2></center>
              <p class="card-text">The votes for this category will help select the <b>Best Special Events character</b> amongst characters released between 1st December 2019 and 30th November 2020</p>
              <center><a href="index.php?page=evenement2" class="btn btn-primary">Access to results</a></center>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><img class="card-img-top" src="https://i.imgur.com/xqHLH34.png" alt="Card image cap"></center>
              <center><h2 class="card-title">Best Treasure Map character</h2></center>
              <p class="card-text">The votes for this category will help select the <b>Best Treasure Map character</b> amongst characters released between 1st December 2019 and 30th November 2020</p>
              <center><a href="index.php?page=tm2" class="btn btn-primary">Access to results</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><img class="card-img-top" src="https://i.imgur.com/5ECHxbY.png" alt="Card image cap"></center>
              <center><h2 class="card-title">Best Kizuna Clash character</h2></center>
              <p class="card-text">The votes for this category will help select the <b>Best Kizuna Clash character</b> amongst characters released between 1st December 2019 and 30th November 2020</p>
              <center><a href="index.php?page=kizuna2" class="btn btn-primary">Access to results</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><img class="card-img-top" src="https://i.imgur.com/ZwmwcG9.png" alt="Card image cap"></center>
              <center><h2 class="card-title">Most useful character on Pirate Rumble</h2></center>
              <p class="card-text">The votes for this category will help select the <b>Most useful character on Pirate Rumble</b> amongst all characters that have Pirate Rumble effects</p>
              <center><a href="index.php?page=pf2" class="btn btn-primary">Access to results</a></center>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><img class="card-img-top" src="https://i.imgur.com/ixqbLRh.png" alt="Card image cap"></center>
              <center><h2 class="card-title">Best Rare Recruit character</h2></center>
              <p class="card-text">The votes for this category will help select the <b>Best Rare Recruit character</b> amongst characters released between 1st December 2019 and 30th November 2020</p>
              <center><a href="index.php?page=rr2" class="btn btn-primary">Access to results</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><img class="card-img-top" src="https://i.imgur.com/aqrrntd.png" alt="Card image cap"></center>
              <center><h2 class="card-title">Best Super Evolution</h2></center>
              <p class="card-text">The votes for this category will help select the <b>Best Super Evolution</b> amongst characters released between 1st December 2019 and 30th November 2020</p>
              <center><a href="index.php?page=supevo2" class="btn btn-primary">Access to results</a></center>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <center><img class="card-img-top" src="https://i.imgur.com/bEMJKxo.png" alt="Card image cap"></center>
              <center><h2 class="card-title">Best Legend</h2></center>
              <p class="card-text">The votes for this category will help select the <b>Best Legend</b> amongst characters released between 1st December 2019 and 30th November 2020</p>
              <center><a href="index.php?page=legende2" class="btn btn-primary">Access to results</a></center>
            </div>
          </div>
        </div>
      </div>
