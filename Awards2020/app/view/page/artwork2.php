...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Best Male Artwork</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Best Male Artwork</u></center></h1>
      <center><img src="https://i.imgur.com/ptvT7KQ.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=artwork">Version française</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - The votes for this category will help select the <b>Best Male Artwork</b> amongst characters released between 1st December 2019 and 30th November 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Number of votes :</u> 2 430</h2></center>
    <br><br>
  ...
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/CMOqa9s.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Future-Controlling Haki</h4>
      <h2 class="card-title">Charlotte Katakuri</h2>
      <p class="card-text"><b>423 votes (17,41 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2962" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/HJT5xH3.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Emperor</h4>
      <h2 class="card-title">Blackbeard</h2>
      <p class="card-text"><b>311 votes (12,8 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2964" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=artwork2&action=submit">
      <label for="select_1">Select your choice :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Whitebeard - End of the Long Journey</option>
        <option value="2">Charlotte Katakuri - Future-Controlling Haki</option>
        <option value="3">Blackbeard - Emperor</option>
        <option value="4">Trafalgar Law - Alliance to Liberate the Land of Wano</option>
      </select>
    <br>
