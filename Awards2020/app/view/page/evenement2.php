...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Best Special Events character</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Best Special Events character</u></center></h1>
      <center><img src="https://i.imgur.com/GYfqRUH.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=evenement">Version française</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - The votes for this category will help select the <b>Best Special Events character</b> amongst characters released between 1st December 2019 and 30th November 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Number of votes :</u> 2 204</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">The One with Invincible Strength</h4>
      <h2 class="card-title">Douglas Bullet</h2>
      <p class="card-text"><b>825 votes (37,43 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2883" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
  ...
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/4oU4Wq6.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Bestest Birthday Ever</h4>
      <h2 class="card-title">Otama</h2>
      <p class="card-text"><b>706 votes (32,03 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2815" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/OzP0seB.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Youths Embarking on a Dream</h4>
      <h2 class="card-title">Straw Hat Pirates</h2>
      <p class="card-text"><b>445 votes (20,09 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2875" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/MYpDAQb.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Man-Eating Monster</h4>
      <h2 class="card-title">Local Sea Monster</h2>
      <p class="card-text"><b>228 votes (10,34 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/3382" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=evenement2&action=submit">
      <label for="select_1">Select your choice :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Otama - Bestest Birthday Ever</option>
        <option value="2">Straw Hat Pirates - Youths Embarking on a Dream</option>
        <option value="3">Douglas Bullet - The One with Invincible Strength</option>
        <option value="4">Local Sea Monster - Man-Eating Monster</option>
      </select>
    <br>
