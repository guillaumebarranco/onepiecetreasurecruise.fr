...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Best Treasure Map character</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Best Treasure Map character</u></center></h1>
      <center><img src="https://i.imgur.com/kGpscnC.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=tm">Version française</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - The votes for this category will help select the <b>Best Treasure Map character</b> amongst characters released between 1st December 2019 and 30th November 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Number of votes :</u> 2 231</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Geisha</h4>
      <h2 class="card-title">Orobi</h2>
      <p class="card-text"><b>1 205 votes (54,01 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2792" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
  ...
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/2OgHoYw.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Strawhat Swordsman</h4>
      <h2 class="card-title">Zorojuro</h2>
      <p class="card-text"><b>475 votes (21,29 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2995" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/oYTUpBh.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Celebrate the Astonishing Cruise</h4>
      <h2 class="card-title">Monkey D. Luffy</h2>
      <p class="card-text"><b>373 votes (16,72 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2977" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/ug56KpO.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Princesses of Dressrosa Kingdom</h4>
      <h2 class="card-title">Rebecca & Viola</h2>
      <p class="card-text"><b>178 votes (7,98 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2850" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=tm2&action=submit">
      <label for="select_1">Select your choice :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Orobi - Geisha</option>
        <option value="2">Rebecca & Viola - Princesses of Dressrosa Kingdom</option>
        <option value="3">Monkey D. Luffy - Celebrate the Astonishing Cruise</option>
        <option value="4">Zorojuro - Strawhat Swordsman</option>
      </select>
    <br>
