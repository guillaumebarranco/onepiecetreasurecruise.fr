...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Best Legend</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Best Legend</u></center></h1>
      <center><img src="https://i.imgur.com/LgEN1jf.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=legende">Version française</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - The votes for this category will help select the <b>Best Legend</b> amongst characters released between 1st December 2019 and 30th November 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Number of votes :</u> 2 372</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Faithful Friends at the Battlefront</h4>
      <h2 class="card-title">Luffy & Sanji</h2>
      <p class="card-text"><b>869 votes (36,64 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/3065" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
  ...
  <br><br><br>
    <center><h2><u>Nominees</u></h2></center>
    <center><div class="col-sm-12">
  <div class="row justify-content-center">
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/94L21Il.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Pirates Fighting for Their Friends</h4>
      <h2 class="card-title">Red-Hair Pirates</h2>
      <p class="card-text"><b>726 votes (30,61 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2862" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/xlk8yJS.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Two Menacing Emperors</h4>
      <h2 class="card-title">Kaido VS Big Mom</h2>
      <p class="card-text"><b>419 votes (17,66 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/3135" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/mDPcdHn.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Alliance to Liberate the Land of Wano</h4>
      <h2 class="card-title">Trafalgar Law</h2>
      <p class="card-text"><b>358 votes (15,09 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/3027" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=legende2&action=submit">
      <label for="select_1">Select your choice :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Red-Hair Pirates - Pirates Fighting for Their Friends</option>
        <option value="2">Trafalgar Law - Alliance to Liberate the Land of Wano</option>
        <option value="3">Luffy & Sanji - Faithful Friends at the Battlefront</option>
        <option value="4">Kaido VS Big Mom - Two Menacing Emperors</option>
      </select>
    <br>
