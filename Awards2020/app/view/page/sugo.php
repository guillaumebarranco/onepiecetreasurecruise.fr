...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Meilleur Sugo-Fest</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
      ...
      <center><img src="https://i.imgur.com/T8DdaMG.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=sugo2">English Version</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - Cette catégorie permettra de décerner <b>l'Award du meilleur Sugo-Fest (uniquement ceux de la version GLB)</b> parmi tous les Sugo-Fest ayant eu lieu entre le 1er décembre 2019 et le 30 novembre 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Nombre de votes :</u> 2 481</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Septembre-Octobre 2020</h4>
      <h2 class="card-title">Sugo-Fest de la mise à jour importante - Ver. 10.0</h2>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Juillet-Août 2020</h4>
      <h2 class="card-title">Sugo-Fest du 5e anniversaire de la version française</h2>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Décembre 2019-Janvier 2020</h4>
      <h2 class="card-title">Sugo-Fest du Nouvel An</h2>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Juillet 2020</h4>
      <h2 class="card-title">Sugo-Fest du jour de One Piece</h2>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=sugo&action=submit">
      <label for="select_1">Sélectionnez votre choix :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Sugo-Fest du Nouvel An</option>
        <option value="2">Sugo-Fest du jour de One Piece</option>
        <option value="3">Sugo-Fest du 5e anniversaire de la version française</option>
        <option value="4">Sugo-Fest de la mise à jour importante - Ver. 10.0</option>
      </select>
    <br>
