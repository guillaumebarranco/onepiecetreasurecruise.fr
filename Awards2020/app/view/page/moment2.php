...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Best moment</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Best moment</u></center></h1>
      <center><img src="https://i.imgur.com/2o3VJV7.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=moment">Version française</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - The votes for this category will help select the <b>Best moment (GLB only)</b> amongst everything that happened on the game between 1st December 2019 and 30th November 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Number of votes :</u> 2 496</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <h2 class="card-title">Ver. 10.0 Major Update Celebration</h2>
      <p class="card-text"><b>1 320 votes (52,88 %)</b></p>
    </div>
  </div>
  </div>
  </div>
  ...
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/SpbaPhz.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">July-August 2020</h4>
      <h2 class="card-title">French Ver. 5th Anniversary</h2>
      <p class="card-text"><b>586 votes (23,48 %)</b></p>
    </div>
  </div>
  </div>
  ...
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/Q2yymBm.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">January 2020</h4>
      <h2 class="card-title">Gem Valley Incident</h2>
      <p class="card-text"><b>531 votes (21,27 %)</b></p>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/kL0aVu5.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">August 2020</h4>
      <h2 class="card-title">Kizuna Clash ! Gecko Moria</h2>
      <p class="card-text"><b>59 votes (2,36 %)</b></p>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=moment2&action=submit">
      <label for="select_1">Select your choice :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Gem Valley Incident</option>
        <option value="2">French Ver. 5th Anniversary</option>
        <option value="3">Kizuna Clash ! Gecko Moria</option>
        <option value="4">Ver. 10.0 Major Update Celebration</option>
      </select>
    <br>
