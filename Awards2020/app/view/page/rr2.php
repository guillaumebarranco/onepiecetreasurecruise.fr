...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Best Rare Recruit character</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Best Rare Recruit character</u></center></h1>
      <center><img src="https://i.imgur.com/iFf6Z8S.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=rr">Version française</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - The votes for this category will help select the <b>Best Rare Recruit character</b> amongst characters released between 1st December 2019 and 30th November 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Number of votes :</u> 2 262</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Toad-Oil Salesman</h4>
      <h2 class="card-title">Usohachi</h2>
      <p class="card-text"><b>1 269 votes (56,1 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2806" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
  ...
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/Oh9GpGi.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Rulers of the East Blue</h4>
      <h2 class="card-title">Krieg & Gin</h2>
      <p class="card-text"><b>468 votes (20,69 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2864" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/Yjalmzv.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Nighttime Vacation on the Beach</h4>
      <h2 class="card-title">Nico Robin</h2>
      <p class="card-text"><b>390 votes (17,24 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/3042" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/I0l2Oc7.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Dedication to Straw Hat Luffy</h4>
      <h2 class="card-title">Boa Hancock</h2>
      <p class="card-text"><b>135 votes (5,97 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2966" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=rr2&action=submit">
      <label for="select_1">Select your choice :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Usohachi - Toad-Oil Salesman</option>
        <option value="2">Krieg & Gin - Rulers of the East Blue</option>
        <option value="3">Boa Hancock - Dedication to Straw Hat Luffy</option>
        <option value="4">Nico Robin - Vacation on the Moonlit Beach</option>
      </select>
    <br>
