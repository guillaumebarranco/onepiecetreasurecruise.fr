...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Meilleure super évolution</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Meilleure super évolution</u></center></h1>
      <center><img src="https://i.imgur.com/HjFlmfa.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=supevo2">English Version</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - Cette catégorie permettra de décerner <b>l'Award de la meilleure super évolution</b> parmi les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Nombre de votes :</u> 2 272</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Fin d'un long voyage</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Vétéran bienveillant</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Grand-père du futur roi des pirates</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Créature de flammes bleues</h4>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=supevo&action=submit">
      <label for="select_1">Sélectionnez votre choix :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Marco le Phénix - Créature de flammes bleues</option>
        <option value="2">Barbe Blanche - Fin d'un long voyage</option>
        <option value="3">Garp le coup de poing - Grand-père du futur roi des pirates</option>
        <option value="4">Silvers Rayleigh le seigneur des ténèbres - Vétéran bienveillant</option>
      </select>
    <br>
