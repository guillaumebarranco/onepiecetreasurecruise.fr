...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Meilleur personnage du combat de l'amitié</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Meilleur personnage du combat de l'amitié</u></center></h1>
      <center><img src="https://i.imgur.com/60cLheK.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=kizuna2">English Version</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - Cette catégorie permettra de décerner <b>l'Award du meilleur personnage du combat de l'amitié</b> parmi les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Nombre de votes :</u> 2 159</h2></center>
    <br><br>
    <center><h2><u>Vainqueur</u></h2></center>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Flammes jumelles de l'équipage de Barbe Blanche</h4>
      <h2 class="card-title">Marco et Ace</h2>
      <p class="card-text"><b>817 votes (37,84 %)</b></p>
      <!-- Button -->
      <a href="https://onepiecetreasurecruise.fr/Bataille%20cooperative/Marco%20et%20Ace.html" target="_blank" class="btn btn-primary">Fiche du personnage</a>
    </div>
  </div>
  </div>
  </div>
  ...
  <br><br><br>
    <center><h2><u>Autres nominés</u></h2></center>
    <center><div class="col-sm-12">
  <div class="row justify-content-center">
  <div class="col-sm-4">
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Front commun pour l'entraînement</h4>
      <h2 class="card-title">Luffy et Hancock</h2>
      <p class="card-text"><b>662 votes (30,66 %)</b></p>
      <!-- Button -->
      <a href="https://onepiecetreasurecruise.fr/Bataille%20cooperative/Luffy%20et%20Hancock.html" target="_blank" class="btn btn-primary">Fiche du personnage</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Belle serveuse vedette de maison de thé</h4>
      <h2 class="card-title">O-Kiku</h2>
      <p class="card-text"><b>466 votes (21,58 %)</b></p>
      <!-- Button -->
      <a href="https://onepiecetreasurecruise.fr/Bataille%20cooperative/O-Kiku.html" target="_blank" class="btn btn-primary">Fiche du personnage</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Réveil du sulong</h4>
      <h2 class="card-title">Carrot</h2>
      <p class="card-text"><b>214 votes (9,91 %)</b></p>
      <!-- Button -->
      <a href="https://onepiecetreasurecruise.fr/Bataille%20cooperative/Carrot.html" target="_blank" class="btn btn-primary">Fiche du personnage</a>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=kizuna&action=submit">
      <label for="select_1">Sélectionnez votre choix :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">O-Kiku - Belle serveuse vedette de maison de thé</option>
        <option value="2">Marco et Ace - Flammes jumelles de l'équipage de Barbe Blanche</option>
        <option value="3">Carrot - Réveil du sulong</option>
        <option value="4">Luffy et Hancock - Front commun pour l'entraînement</option>
      </select>
    <br>
    <center><button class="button button1" type="submit" name="submit" value="Valider">Envoyer</center><br>
    </form>
  </td>
</tr>
  </tbody>
