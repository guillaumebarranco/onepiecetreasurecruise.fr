...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Meilleur moment</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Meilleur moment</u></center></h1>
      <center><img src="https://i.imgur.com/asZaPoc.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=moment2">English Version</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - Cette catégorie permettra de décerner <b>l'Award du meilleur moment (uniquement ceux de la version GLB)</b> parmi tout ce qui s'est passé sur le jeu entre le 1er décembre 2019 et le 30 novembre 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Nombre de votes :</u> 2 496</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <h2 class="card-title">Mise à jour importante - Ver. 10.0</h2>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <h2 class="card-title">5e anniversaire de la version française</h2>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Janvier 2020</h4>
      <h2 class="card-title">Incident de Gem Valley</h2>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Août 2020</h4>
      <h2 class="card-title">Combat de l'amitié de Gecko Moria</h2>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=moment&action=submit">
      <label for="select_1">Sélectionnez votre choix :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Incident de Gem Valley</option>
        <option value="2">5e anniversaire de la version française</option>
        <option value="3">Combat de l'amitié de Gecko Moria</option>
        <option value="4">Mise à jour importante - Ver. 10.0</option>
      </select>
    <br>
