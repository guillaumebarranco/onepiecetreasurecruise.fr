...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
      ...
      <br/><br>
    <center><h2><u>Nombre de votes :</u> 2 204</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Possesseur d'une force inégalée</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Le plus beau des anniversaires</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Jeunes aventuriers</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Monstre mangeur d'hommes</h4>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=evenement&action=submit">
      <label for="select_1">Sélectionnez votre choix :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">O-Tama - Le plus beau des anniversaires</option>
        <option value="2">Équipage de Chapeau de paille - Jeunes aventuriers</option>
        <option value="3">Douglas Bullet - Possesseur d'une force inégalée</option>
        <option value="4">Seigneur de la côte - Monstre mangeur d'hommes</option>
      </select>
    <br>
