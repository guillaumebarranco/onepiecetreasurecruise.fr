...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Meilleure nouveauté</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Meilleure nouveauté</u></center></h1>
      <center><img src="https://i.imgur.com/WfM3BbD.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=nouveaute2">English Version</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - Cette catégorie permettra de décerner <b>l'Award de la meilleure nouveauté (version GLB ou version JPN)</b> parmi toutes les nouveautés sorties entre le 1er décembre 2019 et le 30 novembre 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Nombre de votes :</u> 2 642</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h2 class="card-title">Fête des pirates</h2>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h2 class="card-title">Bazar des médailles</h2>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h2 class="card-title">Île des collectionneurs</h2>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=nouveaute&action=submit">
      <label for="select_1">Sélectionnez votre choix :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Fête des pirates</option>
        <option value="2">Île des collectionneurs</option>
        <option value="3">Super type</option>
        <option value="4">Bazar des médailles</option>
      </select>
    <br>
