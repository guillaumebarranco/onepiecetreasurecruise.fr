...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Biggest hopes for 2021</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Biggest hopes for 2021</u></center></h1>
      <center><img src="https://i.imgur.com/WkjrCXp.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=attente">Version française</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - The votes for this category will help select the <b>Biggest hope for 2021</b> amongst the characters or potential new features.<br><br>
      ...
      <br/><br>
    <center><h2><u>Number of votes :</u> 2 451</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h2 class="card-title">New character "Kozuki Oden"</h2>
      <p class="card-text"><b>889 votes (36,27 %)</b></p>
    </div>
  </div>
  </div>
  </div></center>
  ...
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/BlqAnyy.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h2 class="card-title">Increased success rate of Tablets</h2>
      <p class="card-text"><b>678 votes (27,66 %)</b></p>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/0O2PMrG.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h2 class="card-title">New character "Gol D. Roger"</h2>
      <p class="card-text"><b>617 votes (25,17 %)</b></p>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/tosx0px.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h2 class="card-title">Cotton Candy Storage</h2>
      <p class="card-text"><b>267 votes (10,89 %)</b></p>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=attente2&action=submit">
      <label for="select_1">Select your choice :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">New character "Gol D. Roger"</option>
        <option value="2">New character "Kozuki Oden"</option>
        <option value="3">Increased success rate of Tablets</option>
        <option value="4">Cotton Candy Storage</option>
      </select>
    <br>
