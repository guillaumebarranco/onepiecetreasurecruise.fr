...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Meilleur personnage du recrutement rare</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Meilleur personnage du recrutement rare</u></center></h1>
      <center><img src="https://i.imgur.com/mhtWfEa.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=rr2">English Version</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - Cette catégorie permettra de décerner <b>l'Award du meilleur personnage du recrutement rare (spéciaux non compris)</b> parmi les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Nombre de votes :</u> 2 262</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Vendeur de graisse de crapaud</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Maîtres d'East Blue</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Vacances au clair de lune</h4>
      <h2 class="card-title">Nico Robin</h2>
      <p class="card-text"><b>390 votes (17,24 %)</b></p>
      <!-- Button -->
      <a href="https://onepiecetreasurecruise.fr/Boa%20Hancock%203.html#2" target="_blank" class="btn btn-primary">Fiche du personnage</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Dévotion pour Luffy</h4>
      <h2 class="card-title">Boa Hancock</h2>
      <p class="card-text"><b>135 votes (5,97 %)</b></p>
      <!-- Button -->
      <a href="https://onepiecetreasurecruise.fr/Monkey%20D.%20Luffy%206.html#1" target="_blank" class="btn btn-primary">Fiche du personnage</a>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=rr&action=submit">
      <label for="select_1">Sélectionnez votre choix :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Usohachi - Vendeur de graisse de crapaud</option>
        <option value="2">Krieg et Gyn - Maîtres d'East Blue</option>
        <option value="3">Boa Hancock - Dévotion pour Luffy</option>
        <option value="4">Nico Robin - Vacances sur la plage au clair de lune</option>
      </select>
    <br>
