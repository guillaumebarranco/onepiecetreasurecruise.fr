...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Best Raid / Ambush character</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Best Raid / Ambush character</u></center></h1>
      <center><img src="https://i.imgur.com/wwH8bwj.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=raid">Version française</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - The votes for this category will help select the <b>Best Raid / Ambush character</b> amongst characters released between 1st December 2019 and 30th November 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Number of votes :</u> 2 237</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Captain of the Bonney Pirates</h4>
      <h2 class="card-title">Big Eater Jewelry Bonney</h2>
      <p class="card-text"><b>1 023 votes (45,73 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2846" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
  ...
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/pgsYvOC.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Phantom of the Germa 66</h4>
      <h2 class="card-title">Soba Mask</h2>
      <p class="card-text"><b>485 votes (21,68 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2987" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/YVOhjYR.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Battle Between Wounded Allies</h4>
      <h2 class="card-title">Jinbe</h2>
      <p class="card-text"><b>404 votes (18,06 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2893" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/VJHP89x.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Combat With No Rules</h4>
      <h2 class="card-title">Mr. 0</h2>
      <p class="card-text"><b>325 votes (14,53 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2956" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=raid2&action=submit">
      <label for="select_1">Select your choice :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Big Eater Jewelry Bonney - Captain of the Bonney Pirates</option>
        <option value="2">Jinbe - Battle Between Wounded Allies</option>
        <option value="3">Mr. 0 - Combat With No Rules</option>
        <option value="4">Soba Mask - Phantom of the Germa 66</option>
      </select>
    <br>
