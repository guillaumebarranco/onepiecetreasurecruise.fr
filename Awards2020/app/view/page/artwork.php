...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Meilleur Artwork masculin</title>
...
position: absolute;
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <body>
    	<h1><center><u>Awards 2020 - Meilleur Artwork masculin</u></center></h1>
      <center><img src="https://i.imgur.com/ely1uNF.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=artwork2">English Version</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - Cette catégorie permettra de décerner <b>l'Award du meilleur Artwork masculin</b> parmi tous les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Nombre de votes :</u> 2 430</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Fluide décisif</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Empereur</h4>
    ...
    <!-- <table>
      <table align="center" width="50%">        
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=artwork&action=submit">
      <label for="select_1">Sélectionnez votre choix :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Barbe Blanche - Fin d'un long voyage</option>
        <option value="2">Charlotte Dent-de-chien - Fluide décisif</option>
        <option value="3">Barbe Noire - Empereur</option>
        <option value="4">Trafalgar Law - Alliance pour ouvrir le pays des Wa</option>
      </select>
    <br>
