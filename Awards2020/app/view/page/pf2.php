...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Most useful character on Pirate Rumble</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Most useful character on Pirate Rumble</u></center></h1>
      <center><img src="https://i.imgur.com/ySvDNmi.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=pf">Version française</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - The votes for this category will help select the <b>Most useful character on Pirate Rumble</b> amongst all characters that have Pirate Rumble effects.<br><br>
      ...
      <br/><br>
    <center><h2><u>Number of votes :</u> 2 209</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Judgement of the Divine</h4>
      <h2 class="card-title">Donquixote Doflamingo</h2>
      <p class="card-text"><b>1 454 votes (65,82 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2444" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
  ...
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/sEjmxpr.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Navy HQ Powerhouse</h4>
      <h2 class="card-title">Borsalino</h2>
      <p class="card-text"><b>363 votes (16,43 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2034" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/tPPcvQy.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Wondrous White Sulong</h4>
      <h2 class="card-title">Carrot</h2>
      <p class="card-text"><b>318 votes (14,4 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2338" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/Hzsj86S.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Feast of Reconciliation</h4>
      <h2 class="card-title">Dogstorm</h2>
      <p class="card-text"><b>74 votes (3,35 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2372" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=pf2&action=submit">
      <label for="select_1">Select your choice :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Borsalino - Navy HQ Powerhouse</option>
        <option value="2">Carrot - Wondrous White Sulong</option>
        <option value="3">Dogstorm - Feast of Reconciliation</option>
        <option value="4">Donquixote Doflamingo - Judgement of the Divine</option>
      </select>
    <br>
