...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Personnage le plus utile sur la fête des pirates</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Personnage le plus utile sur la fête des pirates</u></center></h1>
      <center><img src="https://i.imgur.com/DyUuAZd.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=pf2">English Version</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - Cette catégorie permettra de décerner <b>l'Award du personnage le plus utile sur la fête des pirates</b> parmi tous les personnages ayant des effets sur la fête des pirates.<br><br>
      ...
      <br/><br>
    <center><h2><u>Nombre de votes :</u> 2 209</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Punition de dieu</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">La plus puissante des forces de combat de la Marine</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Sulong mystérieuse</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Festin préparé à la main</h4>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=pf&action=submit">
      <label for="select_1">Sélectionnez votre choix :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Borsalino - La plus puissante des forces de combat de la Marine</option>
        <option value="2">Carrot - Sulong mystérieuse</option>
        <option value="3">Caborage - Festin préparé à la main</option>
        <option value="4">Don Quijote Doflamingo - Punition de dieu</option>
      </select>
    <br>
