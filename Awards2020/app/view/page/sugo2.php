...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Best Sugo-Fest</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Best Sugo-Fest</u></center></h1>
      <center><img src="https://i.imgur.com/12JI55V.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=sugo">Version française</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - The votes for this category will help select the <b>Best Sugo-Fest (GLB only)</b> amongst all Sugo-Fest that took place between 1st December 2019 and 30th November 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Number of votes :</u> 2 481</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">September-October 2020</h4>
      <h2 class="card-title">Ver. 10.0 Major Update Celebration Sugo-Fest</h2>
      <p class="card-text"><b>1 321 votes (53,24 %)</b></p>
    </div>
  </div>
  </div>
  </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">July-August 2020</h4>
      <h2 class="card-title">French Ver. 5th Anniversary Sugo-Fest</h2>
      <p class="card-text"><b>883 votes (35,59 %)</b></p>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/nfthuzk.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">December 2019-January 2020</h4>
      <h2 class="card-title">New Year Sugo-Fest</h2>
      <p class="card-text"><b>188 votes (7,58 %)</b></p>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">July 2020</h4>
      <h2 class="card-title">One Piece Day Sugo-Fest</h2>
      <p class="card-text"><b>89 votes (3,59 %)</b></p>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=sugo2&action=submit">
      <label for="select_1">Select your choice :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">New Year Sugo-Fest</option>
        <option value="2">One Piece Day Sugo-Fest</option>
        <option value="3">French Ver. 5th Anniversary Sugo-Fest</option>
        <option value="4">Ver. 10.0 Major Update Celebration Sugo-Fest</option>
      </select>
    <br>
