...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Meilleur personnage des Colisées / Arènes</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Meilleur personnage des Colisées / Arènes</u></center></h1>
      <center><img src="https://i.imgur.com/tswycap.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=colisee2">English Version</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - Cette catégorie permettra de décerner <b>l'Award du meilleur personnage des Colisées / Arènes</b> parmi les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Nombre de votes :</u> 2 190</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Duel de retrouvailles</h4>
      <h2 class="card-title">Caborage</h2>
      <p class="card-text"><b>687 votes (31,37 %)</b></p>
      <!-- Button -->
      <a href="https://onepiecetreasurecruise.fr/Colisee/Caborage%202.html" target="_blank" class="btn btn-primary">Fiche du personnage</a>
    </div>
  </div>
  </div>
  </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <!-- Button -->
      <a href="https://onepiecetreasurecruise.fr/Colisee/King.html" target="_blank" class="btn btn-primary">Fiche du personnage</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Courtisane au masque de renard</h4>
      <h2 class="card-title">Komurasaki</h2>
      <p class="card-text"><b>480 votes (21,92 %)</b></p>
      <!-- Button -->
      <a href="https://onepiecetreasurecruise.fr/Colisee/Komurasaki.html" target="_blank" class="btn btn-primary">Fiche du personnage</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Marchand de soba ambulant</h4>
      <h2 class="card-title">Sangoro</h2>
      <p class="card-text"><b>412 votes (18,81 %)</b></p>
      <!-- Button -->
      <a href="https://onepiecetreasurecruise.fr/Colisee/Sangoro.html" target="_blank" class="btn btn-primary">Fiche du personnage</a>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=colisee&action=submit">
      <label for="select_1">Sélectionnez votre choix :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Sangoro - Marchand de soba ambulant</option>
        <option value="2">Komurasaki - Courtisane au masque de renard</option>
        <option value="3">Caborage - Duel de retrouvailles</option>
