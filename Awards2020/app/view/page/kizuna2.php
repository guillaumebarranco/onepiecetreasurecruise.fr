...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Best Kizuna Clash character</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
	...
	<header><a href="index.php?page=index2"><img src="https://i.imgur.com/V3e73Tf.png" height="50" width="50" alt="logo"></img></a></header>

    <body>
    	<h1><center><u>Awards 2020 - Best Kizuna Clash character</u></center></h1>
      <center><img src="https://i.imgur.com/scXLWZW.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=kizuna">Version française</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - The votes for this category will help select the <b>Best Kizuna Clash character</b> amongst characters released between 1st December 2019 and 30th November 2020.<br><br>
                               - Only one submission per person, all votes coming from the same person will be canceled if there are 2 or more.<br><br>
      ...
      <br/><br>
    <center><h2><u>Number of votes :</u> 2 159</h2></center>
    <br><br>
    <center><h2><u>Winner</u></h2></center>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Dual Flames of the Whitebeard Pirates</h4>
      <h2 class="card-title">Marco & Ace</h2>
      <p class="card-text"><b>817 votes (37,84 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2831" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
  ...
  <br><br><br>
    <center><h2><u>Other nominees</u></h2></center>
    <center><div class="col-sm-12">
  <div class="row justify-content-center">
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/Vs1U9e0.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Alliance Formed for the Sake of Training</h4>
      <h2 class="card-title">Luffy & Hancock</h2>
      <p class="card-text"><b>662 votes (30,66 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2999" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/LCkLhBL.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Tea House Beauty</h4>
      <h2 class="card-title">Okiku</h2>
      <p class="card-text"><b>466 votes (21,58 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2812" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    <center><img class="card-img-top" src="https://i.imgur.com/AQG5MXd.png" alt="Card image cap"></center>
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Awakened True Nature: Sulong</h4>
      <h2 class="card-title">Carrot</h2>
      <p class="card-text"><b>214 votes (9,91 %)</b></p>
      <!-- Button -->
      <a href="https://optc-db.github.io/characters/#/view/2955" target="_blank" class="btn btn-primary">Information</a>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=kizuna2&action=submit">
      <label for="select_1">Select your choice :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Okiku - Tea House Beauty</option>
        <option value="2">Marco & Ace - Dual Flames of the Whitebeard Pirates</option>
        <option value="3">Carrot - Awakened True Nature: Sulong</option>
        <option value="4">Luffy & Hancock - Alliance Formed for the Sake of Training</option>
      </select>
    <br>
    <center><button class="button button1" type="submit" name="submit" value="Valider">Send</center><br>
    </form>
  </td>
</tr>
  </tbody>
