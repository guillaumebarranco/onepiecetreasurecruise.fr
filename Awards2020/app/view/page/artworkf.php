...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Meilleur Artwork féminin</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Meilleur Artwork féminin</u></center></h1>
      <center><img src="https://i.imgur.com/HkuRVb0.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=artworkf2">English Version</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - Cette catégorie permettra de décerner <b>l'Award du meilleur Artwork féminin</b> parmi tous les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Nombre de votes :</u> 2 428</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Vacances devant le soleil couchant</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Moment de détente entre femmes</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Séparation par amour</h4>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Joyeux Noël blanc</h4>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=artworkf&action=submit">
      <label for="select_1">Sélectionnez votre choix :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Nami & Robin - Moment de détente entre femmes</option>
        <option value="2">Charlotte Pudding - Séparation par amour</option>
        <option value="3">Boa Hancock - Vacances sur la plage au coucher de soleil</option>
        <option value="4">Vivi & Rebecca - Joyeux Noël blanc</option>
      </select>
    <br>
