...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Awards 2020 - Meilleur personnage des combats cruciaux / attaques ennemies</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
    	<h1><center><u>Awards 2020 - Meilleur personnage des combats cruciaux / attaques ennemies</u></center></h1>
      <center><img src="https://i.imgur.com/YZKnEsR.png"></img></center>
      <center><a class="btn btn-primary" href="index.php?page=raid2">English Version</a></center><br>
      <!-- <table>
                <table align="center">
                    <tbody>
                       <tr>
                            <td>
                               ...
                               - Cette catégorie permettra de décerner <b>l'Award du meilleur personnage des combats cruciaux / attaques ennemies</b> parmi les personnages sortis entre le 1er décembre 2019 et le 30 novembre 2020.<br><br>
      ...
      <br/><br>
    <center><h2><u>Nombre de votes :</u> 2 237</h2></center>
    <br><br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Capitaine de l'équipage de Bonney</h4>
      <h2 class="card-title">Jewelry Bonney "la gloutonne"</h2>
      <p class="card-text"><b>1 023 votes (45,73 %)</b></p>
      <!-- Button -->
      <a href="https://onepiecetreasurecruise.fr/Raids/Jewelry%20Bonney.html" target="_blank" class="btn btn-primary">Fiche du personnage</a>
    </div>
  </div>
  </div>
  </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Membre légendaire des Germa 66</h4>
      <h2 class="card-title">O-Soba Mask</h2>
      <p class="card-text"><b>485 votes (21,68 %)</b></p>
      <!-- Button -->
      <a href="https://onepiecetreasurecruise.fr/Raids/O-Soba%20Mask.html" target="_blank" class="btn btn-primary">Fiche du personnage</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Duel de blessés</h4>
      <h2 class="card-title">Jinbe</h2>
      <p class="card-text"><b>404 votes (18,06 %)</b></p>
      <!-- Button -->
      <a href="https://onepiecetreasurecruise.fr/Raids/Jinbe.html" target="_blank" class="btn btn-primary">Fiche du personnage</a>
    </div>
  </div>
  </div>
  <div class="col-sm-4">
  <div class="card">
    ...
    <div class="card-body">
      <!-- Title -->
      <h4 class="card-title">Duel sans lâcheté</h4>
      <h2 class="card-title">Mr 0</h2>
      <p class="card-text"><b>325 votes (14,53 %)</b></p>
      <!-- Button -->
      <a href="https://onepiecetreasurecruise.fr/Raids/Crocodile%202.html" target="_blank" class="btn btn-primary">Fiche du personnage</a>
    </div>
  </div>
  </div>
  </div>
    ...
    <!-- <table>
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=raid&action=submit">
      <label for="select_1">Sélectionnez votre choix :</label>
      <select class="form-control" id="select_1" name="vote">
        <option value="1">Jewelry Bonney "la gloutonne" - Capitaine de l'équipage de Bonney</option>
        <option value="2">Jinbe - Duel de blessés</option>
        <option value="3">Mr 0 - Duel sans lâcheté</option>
        <option value="4">O-Soba Mask - Membre légendaire des Germa 66</option>
      </select>
    <br>
