...
<html>
    <head>
      <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <title>Combat de l'amitié par équipe</title>
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active dropdown">
        ...
        <div class="dropdown-menu dropdown-secondary" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item waves-effect waves-light" href="../../Legendes.html">Personnages Sugo-Rare</a>
          ...
          <a class="dropdown-item active waves-effect waves-light" href="../../Bataille cooperative/Prochaine bataille cooperative.html">Prochain combat de l'amitié</a>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
	...
	<header><a href="../Prochaine bataille cooperative.html"><img src="../../img/logo.png" alt="logo"></img></a></header>

    <body>
    	<h1><center><u>Combat de l'amitié par équipe</u></center></h1>
      <center><a href="../Prochaine bataille cooperative.html"><button class="btn btn-primary">Revenir au guide</button></a></center><br>
      <center><a href="index.php?page=rechercheajout"><button class="btn btn-success">S'inscrire sur la recherche d'équipe</button></a> <?php if(!isset($_SESSION['nomequipe'])){?><a href="index.php?page=teamajout"><button class="btn btn-success">S'inscrire sur la proposition d'équipe</button></a> <a href="index.php?page=connexion"><button class="btn btn-success">Connexion pour gérer son équipe</button></a><?php }else{ ?><a href="index.php?page=gestion"><button class="btn btn-success">Gérer son équipe</button></a> <a href="index.php?page=deconnexion"><button class="btn btn-success">Se déconnecter</button></a></center><?php } ?>
      <h2><center><u>Rechercher une équipe</u></center></h2>
      <br>
  <div class="col-sm-12">
  <div class="row">
  <?php foreach ($recherche as $rcr ) { ?>
  <div class="col-sm-4">
  <div class="card">
    <div class="card-body">
        <p class="card-text"><center><h3><?=$rcr->getNom()?></h3><br><u>ID :</u> <?=$rcr->getGameID()?><br><br><u>Commentaire :</u> <?=$rcr->getCommentaire()?><br><br><u>Contact :</u> <?=$rcr->getContact()?></center></p>
</div></div></div>
   <?php
}
?></div></div>
  <h2><center><u>Proposer une équipe</u></center></h2>
  <div class="col-sm-12">
  <div class="row">
  ...
  <div class="card">
    <div class="card-body">
        <p class="card-text"><center><h3><?=$tm->getNomEquipe()?></h3><br><h3>Crée par <?=$tm->getNom()?></h3><br><u>Invitation :</u> <?=$tm->getInvitation()?><br><br><u>Commentaire :</u> <?=$tm->getCommentaire()?><br><br><u>Membres de l'équipe :</u> <?=$tm->getMembre()?><br><br><u>Contact :</u> <?=$tm->getContact()?></center></p>
</div></div></div>
   <?php
}
?></div></div>
