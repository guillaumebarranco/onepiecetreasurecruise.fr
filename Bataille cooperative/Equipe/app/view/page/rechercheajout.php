...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
      ...
      <h2><center><u>Inscription sur la recherche d'équipe</u></center></h2>
      <form method="post" action="index.php?page=rechercheajout&action=submit">
    <center><h5>Nom *</h5> <input type="text" required="required" name="nom"></center>
    <br>
    <center><h5>ID *</h5> <input type="text" required="required" name="gameid"></center>
    <br>
