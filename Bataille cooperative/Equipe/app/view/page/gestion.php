...
<a class="dropdown-item" href="../../AvanceeLRR.html">Avancée des personnages limités au recrutement rare</a>
    ...
    <body>
      ...
      <h2><center><u>Gestion d'équipe</u></center></h2>
      <form method="post" action="index.php?page=gestion&id=<?=$_SESSION['id']?>">
      <center><h5>Nom d'équipe</h5> <input type="text" required="required" name="nomequipe" value="<?=$_SESSION['nomequipe']?>"></center>
    <br>
    <center><h5>Nom du créateur</h5> <input type="text" required="required" name="nom" value="<?=$_SESSION['nom']?>"></center>
    <br>
    <center><h5>Code d'invitation</h5> <input type="text" name="invitation" value="<?=$_SESSION['invitation']?>"></center>
    <br>
    <center><h5>Commentaire</h5> <textarea rows="7" cols="50" required="required" name="commentaire" value="<?=$_SESSION['commentaire']?>"><?php echo htmlspecialchars($_SESSION['commentaire']); ?></textarea></center>
    <br>
    <center><h5>Membres de l'équipe</h5> <textarea rows="7" cols="50" name="membre" value="<?=$_SESSION['membre']?>"><?php echo htmlspecialchars($_SESSION['membre']); ?></textarea></center>
    <br>
    <center><h5>Contact</h5> <textarea rows="7" cols="50" name="contact" value="<?=$_SESSION['contact']?>"><?php echo htmlspecialchars($_SESSION['contact']); ?></textarea></center>
    <br>
    <center><h5>Mot de passe</h5> <input type="password" required="required" name="mdp" value="<?=$_SESSION['mdp']?>"></center></center>
    <br>
    <center><button class="btn btn-success" type="submit" name="modifier" value="Valider">Valider</center>
  </form>
