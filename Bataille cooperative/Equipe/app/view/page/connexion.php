...
<a class="dropdown-item" href="../../AvanceeLRR.html">Avancée des personnages limités au recrutement rare</a>
    ...
    <body>
      ...
      <h2><center><u>Connexion sur la gestion d'équipe</u></center></h2>
      <form action="" method="post">
      <?php if (isset($_SESSION['nomequipe'])) {
      }?>
    <center>Nom d'équipe <input type="text" required="required" name="nomequipe"></center>
    <br />
    <center>Mot de passe <input type="password" required="required" name="mdp"></center>
    <br/>
    <center><button class="btn btn-success" type="submit" name="submit" value="Connexion">Connexion</center>
  </form>
