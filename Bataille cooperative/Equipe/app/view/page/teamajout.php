...
position: absolute;
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <body>
      ...
      <h2><center><u>Inscription sur la proposition d'équipe</u></center></h2>
      <form method="post" action="index.php?page=teamajout&action=submit">
    <center><h5>Nom d'équipe *</h5> <input type="text" required="required" name="nomequipe"></center>
    <br>
    <center><h5>Nom du créateur *</h5> <input type="text" required="required" name="nom"></center>
    <br>
    <center><h5>Code d'invitation</h5> <input type="text" name="invitation"></center>
    <br>
    <center><h5>Commentaire *</h5> <textarea rows="7" cols="50" required="required" name="commentaire"></textarea></center>
    <br>
    <center><h5>Membres de l'équipe</h5> <textarea rows="7" cols="50" name="membre"></textarea></center>
    <br>
    <center><h5>Contact</h5> <textarea rows="7" cols="50" name="contact"></textarea></center>
    <br>
    <center><h5>Mot de passe *</h5> <input type="password" required="required" name="mdp"></center>
    <br>
    <center><button class="btn btn-success" type="submit" name="submit" value="Ajouter">S'inscrire</center>
  </form>
