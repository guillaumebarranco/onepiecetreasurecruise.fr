    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active dropdown">
        ...
        <div class="dropdown-menu dropdown-secondary" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item active waves-effect waves-light" href="../../Kizuna/Prochain_Kizuna.html">Prochain combat de l'amitié</a>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
      ...
      <center><a href="../Prochain_Kizuna.html"><button class="btn btn-primary">Revenir au guide</button></a></center><br>
