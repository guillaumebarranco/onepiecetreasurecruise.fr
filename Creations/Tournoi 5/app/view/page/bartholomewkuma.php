...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
        <body id="DEX">
      <h1><center><u>Création de Scaragnark3</u></center></h1>
        <h2><center><u>Personnage Sugo-Rare crée : Bartholomew Kuma</u></center></h2>
        <h2><center><u>Fiche du personnage Sugo-Rare</u></center></h2>
        <table>
          <table align="center">
            <center><img src="https://i.imgur.com/xKC78yk.png"></center>
          <caption><img src="https://i.imgur.com/sWntKO9.jpg"></caption>
            <tbody>
              <tr>
                <td>Nom</td>
              ...
              <tr>
                    ...
                    <tr>
                        ...
                        <td>Personnages soutenus :<br>
                            ...
                            <ul style="display: inline;">Nami</ul><br>
                            <ul style="display: inline;">Usopp</ul><br>
                            <ul style="display: inline;">Sanji Vinsmoke</ul><br>
                            <ul style="display: inline;">Tony-Tony Chopper</ul><br>
                            <ul style="display: inline;">Nico Robin</ul><br>
                            <ul style="display: inline;">Franky</ul><br>
