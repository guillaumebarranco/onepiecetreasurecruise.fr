...
<html>
    <head>
        ...
        <title>Tournoi de créations de personnages 5</title>
            ...
            <tbody>
              <tr>
                ...
                <img src="https://i.imgur.com/qgElw1k.png" alt="KumaMoria"/>
                        ...
                        <td>
                            <a href="index.php?page=ener">
                                <img src="https://i.imgur.com/A2goU7C.png" alt="Ener"/>
                            </a>
                        </td>
                        <td>
                            <a href="index.php?page=luffykidd">
                                <img src="https://i.imgur.com/AVGzUy1.png" alt="LuffyKidd"/>
                            </a>
                        </td>
                        <td>
                            <a href="index.php?page=acebarbenoire">
                                <img src="https://i.imgur.com/vNzgFFm.png" alt="AceBarbeNoire"/>
                            </a>
                        </td>
                        <td>
                            <a href="index.php?page=crocodileint1">
                                <img src="https://i.imgur.com/U8urSBX.jpg" alt="CrocodileINT1"/>
                            </a>
                        </td>
                        <td>
                            <a href="index.php?page=charlotteoven">
                                <img src="https://i.imgur.com/nsVDBcf.png" alt="CharlotteOven"/>
                            </a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <a href="index.php?page=roblucci">
                                <img src="https://i.imgur.com/i1bGjX6.png" alt="RobLucci"/>
                            </a>
                        </td>
                        <td>
                            <a href="index.php?page=crocodileint2">
                                <img src="https://i.imgur.com/tVTVZfd.png" alt="CrocodileINT2"/>
                            </a>
                        </td>
                        <td>
                            <a href="index.php?page=bartholomewkuma">
                                <img src="https://i.imgur.com/xKC78yk.png" alt="Kuma"/>
                            </a>
                        </td>
                        <td>
                            <a href="index.php?page=eustasskidd">
                                <img src="https://i.imgur.com/9GW2Xbk.png" alt="Kidd"/>
                            </a>
                        </td>
                        <td>
                            <a href="index.php?page=crocodileint3">
                                <img src="https://i.imgur.com/H82Hr2H.png" alt="CrocodileINT3"/>
                            </a>
                        </td>
              </tr>
                    <tr>
...
<select class="form-control" id="select_1" name="vote">
    <option value="1">Rob Lucci</option>
    <option value="2">Ace et Barbe Noire</option>
</select>
    <br>
    <center><button class="button button1" type="submit" name="submit" value="Valider">Envoyer</center><br>
        ...
        <center><iframe src="https://challonge.com/fr/hgrvzd4p/module" width="100%" height="500" frameborder="0" scrolling="auto" allowtransparency="true"></iframe></center>
