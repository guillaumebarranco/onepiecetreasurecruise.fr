...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
        <body id="INT">
      <h1><center><u>Création de Diaboliquehomme</u></center></h1>
        <h2><center><u>Personnage Sugo-Rare crée : Crocodile (INT, 2)</u></center></h2>
        <h2><center><u>Fiche du personnage Sugo-Rare</u></center></h2>
        <table>
          <table align="center">
            <center><img src="https://i.imgur.com/tVTVZfd.png"></center>
          <caption><img src="https://i.imgur.com/YwZqEZ2.png"></caption>
            <tbody>
              <tr>
                <td>Nom</td>
