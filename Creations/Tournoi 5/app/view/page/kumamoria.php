...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
        <body id="STRPSY">
      <h1><center><u>Création de Pacifo</u></center></h1>
        <h2><center><u>Personnage Sugo-Rare crée : Kuma et Moria</u></center></h2>
        <h2><center><u>Fiche du personnage Sugo-Rare</u></center></h2>
        <table>
          <table align="center">
            <center><img src="https://i.imgur.com/qgElw1k.png"></center>
          <caption><img src="https://i.imgur.com/zfkh4Ja.jpg"></caption>
            <tbody>
              <tr>
                <td>Nom</td>
              ...
              <tr>
                ...
                <td>
                            ...
                            <b><font color="#ECAC04">Gecko Moria</font></b> : 1857 puis 2057 après le dépassement de limites<br>
              ...
              <tr>
                ...
                <td>
                            ...
                            <b><font color="#ECAC04">Gecko Moria</font></b> : Multiplie l'ATK des personnages de classe Tireur, Tenace, Sabreur, Ambitieux et Ravageur par 1,825 (par 3,33 pour les personnages qui ont 2 classes), les HP par 1,35, réduit le temps de chargement des coups spéciaux de 2 tours au début de la quête, réduit les dégâts subis de 10% et si l'équipe contient un personnage de classe Tireur, un de classe Tenace, un de classe Sabreur et un de classe Ambitieux et un de classe Ravageur, multiplie l'ATK de tous les personnages par 1,5 (par 2,7375 pour les personnages qui ont une classe et par 4,995 pour les personnages qui ont 2 classes).<br><br>
