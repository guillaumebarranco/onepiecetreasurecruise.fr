...
<html>
    <head>
        ...
        <title>Rayleigh VS Kizaru</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
        <body id="INTSTR">
        <h1><center><u>Création de Kyyn</u></center></h1>
        <h2><center><u>Personnage Sugo-Rare crée : Rayleigh VS Kizaru</u></center></h2>
        <h2><center><u>Fiche du personnage Sugo-Rare</u></center></h2>
        <center><img src="https://i.imgur.com/GsoqmWy.png"></center>
        <table>
          <table align="center">
          <caption><img src="https://i.imgur.com/FHsQrLZ.png"></caption>
            <tbody>
              <tr>
                <td>Nom</td>
              ...
              <tr>
                ...
                <td>
                    ...
                    <hr>
                    <b><font color="#DC241C">Kizaru</font></b> : ATK des personnages de type <b><font color="#DC241C">STR</font></b>, <b><font color="#1CAC24">DEX</font></b> et <b><font color="#A916B6">INT</font></b> x5, ATK des personnages de type <b><font color="#4C4CFF">QCK</font></b> et <b><font color="#ECAC04">PSY</font></b> x3.5. Enlève jusqu'à 40% des HP des ennemis au prochain stage en ignorant les effets defensifs en fonction du nombre de parfait effectué au stage précédent.<br>
