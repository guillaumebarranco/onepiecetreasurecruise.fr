...
<html>
    <head>
        ...
        <title>Tournoi de créations de personnages 8</title>
        <link href="app/view/assets/bootstrap.css" rel="stylesheet">
        <link rel="stylesheet" href="app/view/assets/styleCreation2.css" />
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
	...
	<header><a href="../../../Creations.html"><img src="https://i.imgur.com/V3e73Tf.png" height="50" width="50" alt="logo"></img></a></header>
    ...
    <body>
      ...
      <table>
            ...
            <tbody>
              <tr>
                ...
                <img src="https://i.imgur.com/O1sVNM8.png" alt="BBShanks"/>
                        ...
                        <td>
                            <a href="index.php?page=usoppluffy">
                                <img src="https://i.imgur.com/IS52PRe.png" alt="UsoppLuffy"/>
                            </a>
                        </td>
                        <td>
                            <a href="index.php?page=rayleighkizaru">
                                <img src="https://i.imgur.com/GsoqmWy.png" alt="RayleighKizaru"/>
                            </a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <a href="index.php?page=enerluffy">
                                <img src="https://i.imgur.com/VFlv9Ru.png" alt="EnerLuffy"/>
                            </a>
                        </td>
                        <td>
                            <a href="index.php?page=kuzansakazuki">
                                <img src="https://i.imgur.com/VkxDJFe.png" alt="KuzanSakazuki"/>
                            </a>
                        </td>
                        <td>
                            <a href="index.php?page=acebn">
                                <img src="https://i.imgur.com/L93wJy3.png" alt="AceBN"/>
                            </a>
                        </td>
              </tr>
                    <tr>
        ...
        <!-- <h2><center><u>Journée 5</u></center></h2>
      ...
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=index&action=submit">
    <center><h5>Pseudo ou nom</h5> <input type="text" required="required" name="pseudo"></center>
    <br>
    <label for="select_1">Sélectionnez votre choix :</label>
<select class="form-control" id="select_1" name="vote">
    <option value="1">Barbe Blanche VS Shanks</option>
    <option value="2">Ener VS Luffy</option>
</select>
    <br>
    <center><button class="button button1" type="submit" name="submit" value="Valider">Envoyer pour le match 1</center><br>
    </form>
  </td>
</tr>
  </tbody>
      ...
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=index&action=submit2">
    <center><h5>Pseudo ou nom</h5> <input type="text" required="required" name="pseudo"></center>
    <br>
    <label for="select_1">Sélectionnez votre choix :</label>
<select class="form-control" id="select_1" name="vote">
    <option value="1">Ace VS Barbe Noire</option>
    <option value="2">Kuzan VS Sakazuki</option>
</select>
    <br>
    <center><button class="button button1" type="submit" name="submit2" value="Valider">Envoyer pour le match 2</center><br>
    </form>
  </td>
</tr>
  </tbody>
      ...
      <table align="center" width="50%">
            <tbody>
              <tr>
                <td>
    <form method="post" action="index.php?page=index&action=submit3">
    <center><h5>Pseudo ou nom</h5> <input type="text" required="required" name="pseudo"></center>
    <br>
    <label for="select_1">Sélectionnez votre choix :</label>
<select class="form-control" id="select_1" name="vote">
    <option value="1">Rayleigh VS Kizaru</option>
    <option value="2">Usopp VS Luffy</option>
</select>
    <br>
    <center><button class="button button1" type="submit" name="submit3" value="Valider">Envoyer pour le match 3</center><br>
    </form>
  </td>
</tr>
  </tbody>
          ...
          <table id="classement" align="center">
            <tbody>
              <tr>
                ...
                <td id="classement"><center><b>Pseudo sur Discord</b></center></td>
                <td id="classement"><center><b>Création</b></center></td>
                <td id="classement"><center><b>Total</b></center></td>
              </tr>
              <tr>
                <td id="classement"><center><b>1</b></center></center></td>
                <td id="classement"><center>Webarranco</center></center></td>
                <td id="classement"><center><a href="index.php?page=enerluffy">
                <img src="https://i.imgur.com/VFlv9Ru.png" alt="Ener"/>
              </a></center></td>
                <td id="classement"><center><b>12</b></center></td>
              </tr>
              <tr>
                <td id="classement"><center><b>2</b></center></center></td>
                <td id="classement"><center>PerrierCitron</center></center></td>
                <td id="classement"><center><a href="index.php?page=kuzansakazuki">
                <img src="https://i.imgur.com/VkxDJFe.png" alt="KuzanSakazuki"/>
              </a></center></td>
                <td id="classement"><center><b>10</b></center></td>
              </tr>
              <tr>
                <td id="classement"><center><b>3</b></center></center></td>
                <td id="classement"><center>Kyyn</center></center></td>
                <td id="classement"><center><a href="index.php?page=rayleighkizaru">
                <img src="https://i.imgur.com/GsoqmWy.png" alt="RayleighKizaru"/>
              </a></center></td>
                <td id="classement"><center><b>9</b></center></td>
              </tr>
              <tr>
                <td id="classement"><center><b>4</b></center></center></td>
                <td id="classement"><center>Ali</center></center></td>
                <td id="classement"><center><a href="index.php?page=usoppluffy">
                <img src="https://i.imgur.com/IS52PRe.png" alt="UsoppLuffy"/>
              </a></center></td>
                <td id="classement"><center><b>8</b></center></td>
              </tr>
              <tr>
                <td id="classement"><center><b>5</b></center></center></td>
                <td id="classement"><center>DriDri</center></center></td>
                <td id="classement"><center><a href="index.php?page=bbshanks">
                <img src="https://i.imgur.com/O1sVNM8.png" alt="BBShanks"/>
              </a></center></td>
                <td id="classement"><center><b>4</b></center></td>
              </tr>
              <tr>
                <td id="classement"><center><b>6</b></center></center></td>
                <td id="classement"><center>Jaken</center></center></td>
                <td id="classement"><center><a href="index.php?page=acebn">
                <img src="https://i.imgur.com/L93wJy3.png" alt="AceBN"/>
              </a></center></td>
                <td id="classement"><center><b>0</b></center></td>
              </tr>
            </tbody>
        </table>
        <center><iframe src="https://challonge.com/fr/t6rmw2k/module" width="100%" height="1000" frameborder="0" scrolling="auto" allowtransparency="true"></iframe></center>
