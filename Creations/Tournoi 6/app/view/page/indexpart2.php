...
<html>
    <head>
        ...
        <title>Tournoi de créations de personnages 6 - Partie 2</title>
...
<select class="form-control" id="select_1" name="vote">
    <option value="1">Usopp, Oignon, Piment et Carotte</option>
    <option value="2">Équipage du Heart</option>
</select>
    <br>
    <center><button class="button button1" type="submit" name="submit" value="Valider">Envoyer</center><br>
        ...
        <center><iframe src="https://challonge.com/fr/hve8ffzp/module" width="100%" height="500" frameborder="0" scrolling="auto" allowtransparency="true"></iframe></center>
