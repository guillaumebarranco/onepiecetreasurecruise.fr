...
<html>
    <head>
        ...
        <title>Bellamy et Sarquiss</title>
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
        ...
        <h2><center><u>Personnage de la Carte aux trésors crée : Bellamy et Sarquiss</u></center></h2>
        <h2><center><u>Fiche du personnage de la Carte aux trésors</u></center></h2>
        <table>
          <table align="center">
            <center><img src="https://i.imgur.com/TTfDXhv.png"></center>
          <caption><img src="https://i.imgur.com/jEZKzzz.png"></caption>
            <tbody>
              <tr>
                <td>Nom</td>
              ...
              <tr>
                ...
                <ul style="display: inline;"><b>3 à 4 tours :</b> Par 1,75.</ul><br>
                <ul style="display: inline;"><b>5 à 7 tours :</b> Par 2.</ul><br>
