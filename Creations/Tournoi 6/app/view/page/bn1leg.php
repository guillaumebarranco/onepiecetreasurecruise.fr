...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
        <body id="INT">
        <h1><center><u>Création de Hyakuju</u></center></h1>
        <h2><center><u>Personnage Sugo-Rare crée : Barbe Noire (1)</u></center></h2>
        <h2><center><u>Fiche du personnage Sugo-Rare</u></center></h2>
        <table>
          <table align="center">
            <center><img src="https://i.imgur.com/eKDpHwS.png"></center>
          <caption><img src="https://i.imgur.com/F2A7VSF.jpg"></caption>
            <tbody>
              <tr>
                <td>Nom</td>
              ...
              <tr>
                ...
                <td>
                            ...
                            <b><font color="#A916B6">Barbe Noire - Tremblements</font></b> : Multiplie l'ATK des personnages de classe Libre, Intellectuel, Tenace et Ambitieux par 3,75, les HP par 1,35, augmente les chances d'apparition des cercles <b><font color="#A916B6">[INT]</font></b>, rend les cercles <b><font color="#A916B6">[INT]</font></b> avantageux pour les personnages de classe Libre, Intellectuel, Tenace et Ambitieux et enlève 20% des HP de chaque ennemi au début de chaque tour. Permet aux attaques normales d'ignorer les effets défensifs dont bénéficient les ennemis et l'équipe.<br>
              ...
              <tr>
                ...
                <td>
                            ...
                            <b><font color="#A916B6">Barbe Noire - Tremblements</font></b> : Ajoute 50 en HP et ATK pour les personnages de classe Libre, Intellectuel, Tenace et Ambitieux.<br>
                            <b><font color="#A916B6">Barbe Noire - Ténèbres et Tremblements</font></b> : Ajoute 125 en HP et ATK pour les personnages de classe Libre, Intellectuel, Tenace et Ambitieux.<br>
                        </td>
              </tr>
              <tr>
