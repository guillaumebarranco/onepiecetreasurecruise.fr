...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
        ...
        <h2><center><u>Personnage Sugo-Rare crée : Barbe Noire (2)</u></center></h2>
        <h2><center><u>Fiche du personnage Sugo-Rare</u></center></h2>
        <table>
          <table align="center">
            <center><img src="https://i.imgur.com/0jgq5Gr.png"></center>
          <caption><img src="https://i.imgur.com/AN49ZgB.jpg"></caption>
            <tbody>
              <tr>
                <td>Nom</td>
              ...
              <tr>
                <td>Classe 1</td>
                <td><img src="https://i.imgur.com/KD5mQrh.png" height="20" width="20" style="vertical-align: bottom;"/> Ambitieux</td>
              </tr>
              <tr>
                <td>Classe 2</td>
              ...
              <tr>
                ...
                <ul style="display: inline;"><b>2 personnages :</b> Ajoute 0,4 au multiplicateur de combos pendant un tour.</ul><br>
                <ul style="display: inline;"><b>3 personnages :</b> Ajoute 0,6 au multiplicateur de combos pendant un tour.</ul><br>
                <ul style="display: inline;"><b>4 personnages :</b> Ajoute 0,8 au multiplicateur de combos pendant un tour.</ul><br>
