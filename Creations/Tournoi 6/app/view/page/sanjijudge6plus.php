...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
	...
	<header><a href="index.php?page=indexpart1"><img src="https://i.imgur.com/V3e73Tf.png" height="50" width="50" alt="logo"></img></a></header>

    <body>
        <body id="PSY">
        <h1><center><u>Création de Dexacrys</u></center></h1>
        <h2><center><u>Super évolution crée : Sanji et Judge</u></center></h2>
        <h2><center><u>Fiche de la super évolution</u></center></h2>
        <table>
          <table align="center">
            <center><img src="https://i.imgur.com/lY5PjvZ.png"></center>
          <caption><img src="https://i.imgur.com/qujcMyM.png"></caption>
            <tbody>
              <tr>
                <td>Nom</td>
              ...
              <tr>
                ...
                <td>
                            ...
                            <b><font color="#ECAC04">Judge Vinsmoke</font></b> : 1672 puis 1882 après le dépassement de limites puis 2082 après l'extension du dépassement de limites<br>
              ...
              <tr>
                ...
                <td>
                            ...
                            <b><font color="#ECAC04">Judge Vinsmoke</font></b> : Si l'équipe contient un personnage de chaque type, multiplie l'ATK de tous les personnages par 3,75, les HP par 1,5 et rend les cercles <b><font color="#ECAC04">[PSY]</font></b> avantageux pour tous les personnages.<br>
              ...
              <tr>
                ...
                <td>Multiplie l'ATK et les effets des cercles des personnages de classe Tenace par 2,25 pendant un tour, réduit la durée de "Paralysie" de 6 tours et devient "Sanji et Judge" pendant 3 tours.</td>
                    ...
                    <tr>
                        ...
                        <td>Libère le personnage de "Lien des coups spéciaux", change son cercle (cercle <b><font color="darkslateblue">[BLK]</font></b> inclus) en cercle <b><font color="peru">[TND]</font></b> et multiplie le multiplicateur de combos par 1,3 pendant un tour.</td>
                    </tr>
                    <tr>
              ...
              <tr>
                ...
                <td>Si un coup "PARFAIT" est effectué avec ce personnage, 80% de chances de faire 8% l'ATK du personnage en dégâts additionnels.</td>
                    ...
                    <tr>
                        <td colspan="2"><center><a href="../../../Legende/Sanji_Judge.html"><img src="https://onepiece-treasurecruise.com/en/wp-content/uploads/sites/2/f2446.png" height="8%" width="8%"></a></center></td>
                    </tr>
                </tbody>
          </table>
