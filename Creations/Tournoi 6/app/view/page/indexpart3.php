...
<html>
    <head>
        ...
        <title>Tournoi de créations de personnages 6 - Partie 3</title>
...
position: absolute;
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <body>
      ...
      <h2><center><u>Partie 3</u></center></h2>
      ...
      <table>         
          <table align="center">        
            <tbody>
              <tr>
                ...
                <td>
                  <a href="index.php?page=crocodileleg">
              ...
              <tr>
                ...
                <td>
                  <a href="index.php?page=kaidoleg">
        ...
        <center><a href="index.php?page=doflamingoleg"><img src="https://i.imgur.com/rFgBAlB.png" alt="Doflamingo"/></a> <a href="index.php?page=bn2leg"><img src="https://i.imgur.com/0jgq5Gr.png" alt="BN2"/></a></center>
        <table>
...
<select class="form-control" id="select_1" name="vote">
    <option value="1">Don Quijote Family</option>
    <option value="2">Barbe Noire (2)</option>
</select>
    <br>
    <center><button class="button button1" type="submit" name="submit" value="Valider">Envoyer</center><br>
        ...
        <center><iframe src="https://challonge.com/fr/bkv8jjrx/module" width="100%" height="500" frameborder="0" scrolling="auto" allowtransparency="true"></iframe></center>
