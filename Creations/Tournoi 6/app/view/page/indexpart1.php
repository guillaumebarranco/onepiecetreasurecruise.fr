...
<html>
    <head>
        ...
        <title>Tournoi de créations de personnages 6 - Partie 1</title>
...
<a class="dropdown-item" href="../../AvanceeLRR.html">Avancée des personnages limités au recrutement rare</a>
    ...
    <body>
      ...
      <h2><center><u>Partie 1</u></center></h2>
      ...
      <table>
          <table align="center">
            <tbody>
              <tr>
                <td>
                  <a href="index.php?page=luffyace6plus">
                <img src="https://i.imgur.com/uSorQxV.png" alt="LuffyAce"/>
              </a>
            </td>
                <td>
                  <a href="index.php?page=sanjijudge6plus">
                <img src="https://i.imgur.com/lY5PjvZ.png" alt="SanjiJudge"/>
              </a>
            </td>
                <td>
                  <a href="index.php?page=cracker6plus">
                <img src="https://i.imgur.com/fHZe7Jv.png" alt="Cracker"/>
              </a>
            </td>
                <td>
                  <a href="index.php?page=garp6plus">
                <img src="https://i.imgur.com/xfivell.png" alt="Garp"/>
              </a>
            </td>
                    </tr>
              <tr>
                <td>
                  <a href="index.php?page=bigmom6plus">
                <img src="https://i.imgur.com/CPajCp2.png" alt="BigMom"/>
              </a>
            </td>
                <td>
                  <a href="index.php?page=jack6plus">
                <img src="https://i.imgur.com/Ap0Obhv.png" alt="Jack"/>
              </a>
            </td>
                <td>
                  <a href="index.php?page=bartocav6plus">
        ...
        <center><a href="index.php?page=sanjijudge6plus"><img src="https://i.imgur.com/lY5PjvZ.png" alt="SanjiJudge"/></a> <a href="index.php?page=garp6plus"><img src="https://i.imgur.com/xfivell.png" alt="Garp"/></a></center>
        <table>
...
<select class="form-control" id="select_1" name="vote">
    <option value="1">Sanji et Judge</option>
    <option value="2">Monkey D. Garp</option>
</select>
    <br>
    <center><button class="button button1" type="submit" name="submit" value="Valider">Envoyer</center><br>
        ...
        <center><iframe src="https://challonge.com/fr/nv4rd8ko/module" width="100%" height="500" frameborder="0" scrolling="auto" allowtransparency="true"></iframe></center>
