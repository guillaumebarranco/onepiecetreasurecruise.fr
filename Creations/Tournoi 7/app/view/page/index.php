...
<html>
    <head>
        ...
        <title>Tournoi de créations de personnages 7</title>
        <link href="app/view/assets/bootstrap.css" rel="stylesheet">
        <link rel="stylesheet" href="app/view/assets/styleCreation.css" />
...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
      <h1><center><u>Tournoi de créations de personnages 7</u></center></h1>
      ...
      <table>
          <table align="center">
            <tbody>
              <tr>
                <td>
                  <a href="index.php?page=ashura">
                <img src="https://i.imgur.com/QX99q7S.png" alt="Ashura"/>
              </a>
            </td>
                        <td>
                            <a href="index.php?page=corvo">
                                <img src="https://i.imgur.com/lLqEIiw.png" alt="Corvo"/>
                            </a>
                        </td>
                        <td>
                            <a href="index.php?page=apoo">
                                <img src="https://i.imgur.com/GJdz3aN.png" alt="Apoo"/>
                            </a>
                        </td>
                        <td>
                            <a href="index.php?page=zoro">
                                <img src="https://i.imgur.com/LtyIzH3.png" alt="Zoro"/>
                            </a>
                        </td>
                        <td>
                            <a href="index.php?page=hawkinsdrake">
                                <img src="https://i.imgur.com/VWBTZnX.png" alt="HawkinsDrake"/>
                            </a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <a href="index.php?page=robin">
                                <img src="https://i.imgur.com/UleaR4g.png" alt="Robin"/>
                            </a>
                        </td>
                        <td>
                            <a href="index.php?page=kaido">
                                <img src="https://i.imgur.com/e5iVM6J.png" alt="Kaido"/>
                            </a>
                        </td>
                        <td>
                            <a href="index.php?page=luffykidd">
                                <img src="https://i.imgur.com/oxYsWZt.png" alt="LuffyKidd"/>
                            </a>
                        </td>
                        <td>
                            <a href="index.php?page=drake">
                                <img src="https://i.imgur.com/imXoaeB.png" alt="Drake"/>
                            </a>
                        </td>
              </tr>
                    <tr>
        ...
        <center><a href="index.php?page=hawkinsdrake"><img src="https://i.imgur.com/VWBTZnX.png" alt="HawkinsDrake"/></a> <a href="index.php?page=apoo"><img src="https://i.imgur.com/GJdz3aN.png" alt="Apoo"/></a></center>
        <table>
...
<select class="form-control" id="select_1" name="vote">
    <option value="1">Hawkins et Drake</option>
    <option value="2">Scratchmen Apoo</option>
</select>
    <br>
    <center><button class="button button1" type="submit" name="submit" value="Valider">Envoyer</center><br>
        ...
        <center><iframe src="https://challonge.com/fr/uzlbgkad/module" width="100%" height="500" frameborder="0" scrolling="auto" allowtransparency="true"></iframe></center>
