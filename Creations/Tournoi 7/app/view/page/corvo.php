...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
        <body id="STR">
        <h1><center><u>Création de GarGooille</u></center></h1>
        <h2><center><u>Personnage Sugo-Rare crée : Ace, Luffy et Sabo</u></center></h2>
        <h2><center><u>Fiche du personnage Sugo-Rare</u></center></h2>
        <center><img src="https://i.imgur.com/lLqEIiw.png"></center>
        <table>
          <table align="center">
          <caption><img src="https://i.imgur.com/KcKTepD.jpg"></caption>
            <tbody>
              <tr>
                <td>Nom</td>
