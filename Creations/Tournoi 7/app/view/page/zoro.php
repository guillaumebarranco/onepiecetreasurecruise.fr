...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
        ...
        <h2><center><u>Personnage Sugo-Rare crée : Roronoa Zoro</u></center></h2>
        <h2><center><u>Fiche du personnage Sugo-Rare</u></center></h2>
        <center><img src="https://i.imgur.com/LtyIzH3.png"></center>
        <table>
          <table align="center">
          <caption><img src="https://i.imgur.com/H0f1Pvs.png"></caption>
            <tbody>
              <tr>
                <td>Nom</td>
              ...
              <tr>
                <td>Classe 1</td>
                <td><img src="https://i.imgur.com/NPdyphi.png" height="20" width="20" style="vertical-align: bottom;"/> Sabreur</td>
              </tr>
              <tr>
                <td>Classe 2</td>
              ...
              <tr>
                ...
                Explications des cercles <b><font color="saddlebrown">[RYUO]</font></b> et <b><font color="saddlebrown">[SUPER RYUO]</font></b> :<br>
                  <ul style="display: inline;">Lorsqu'un personnage avec un cercle <b><font color="saddlebrown">[RYUO]</font></b> effectue un coup "PARFAIT", change le cercle du personnage en cercle <b><font color="saddlebrown">[SUPER RYUO]</font></b> au tour suivant. S'il effectue un coup "BIEN" ou SUPER", garde son cercle <b><font color="saddlebrown">[RYUO]</font></b> au tour suivant.</ul><br>
                  <ul style="display: inline;">Lorsqu'un personnage avec un cercle <b><font color="saddlebrown">[SUPER RYUO]</font></b> effectue un coup "PARFAIT", ajoute 10% des dégâts infligés par le personnage en dégâts non élémentaires en ignorant les effets défensifs.</ul><br>
                  <ul style="display: inline;">Lorsqu’un personnage attaque avec un cercle <b><font color="saddlebrown">[SUPER RYUO]</font></b>, le plonge en repos au tour suivant (change son cercle en cercle <b><font color="orange">[REPOS]</font></b> et réduit de 100 l'ATK de base du personnage).</ul><br><br>
                Explications des cercles <b><font color="orange">[REPOS]</font></b> :<br>
              ...
              <tr>
                ...
                <td>Le personnage doit être capitaine ou capitaine ami et 2 500 000 points de dégâts doivent avoir été infligés en un tour en utilisant au maximum un coup spécial.</td>
                    ...
                    <tr>
                        ...
                        <small>Multiplie les effets de type des ATK normales des personnages de type <b><font color="#1CAC24">DEX</font></b> par 2,5 contre les ennemis de type <b><font color="#4C4CFF">QCK</font></b> et par 0,75 contre les ennemis de type <b><font color="#DC241C">STR</font></b>.</small><br>
                        <small>Multiplie les effets de type des ATK normales des personnages de type <b><font color="#4C4CFF">QCK</font></b> par 2,5 contre les ennemis de type <b><font color="#DC241C">STR</font></b> et par 0,75 contre les ennemis de type <b><font color="#1CAC24">DEX</font></b>.</small><br>
              ...
              <tr>
                    ...
                    <tr>
                        ...
                        <td>Personnages soutenus :<br>
                            ...
                            <ul style="display: inline;">Hitetsu Tenguyama</ul><br>
                            <ul style="display: inline;">Caborage</ul><br>
                            <ul style="display: inline;">Raizo</ul><br>
                            <ul style="display: inline;">Kinémon</ul><br>
