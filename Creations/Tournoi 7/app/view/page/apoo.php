...
<a class="dropdown-item" href="../../AvanceeFetePirates.html">Avancée des personnages de la Fête des Pirates</a>
    ...
    <body>
        <body id="DEX">
        <h1><center><u>Création de Timinou</u></center></h1>
        <h2><center><u>Personnage Sugo-Rare crée : Scratchmen Apoo</u></center></h2>
        <h2><center><u>Fiche du personnage Sugo-Rare</u></center></h2>
        <center><img src="https://i.imgur.com/GJdz3aN.png"></center>
        <table>
          <table align="center">
          <caption><img src="https://i.imgur.com/m48bZwu.jpg"></caption>
            <tbody>
              <tr>
                <td>Nom</td>
              ...
              <tr>
                    ...
                    <tr>
                        ...
                        <td>Personnages soutenus :<br>
                            ...
                            <ul style="display: inline;">Trafalgar Law</ul><br>
                            <ul style="display: inline;">X-Drake</ul><br>
                            <ul style="display: inline;">Eustass Kidd</ul><br>
                            <ul style="display: inline;">Killer</ul><br>
                            <ul style="display: inline;">Jewelry Bonney</ul><br>
                            <ul style="display: inline;">Urouge</ul><br>
                            <ul style="display: inline;">Basil Hawkins</ul><br>
